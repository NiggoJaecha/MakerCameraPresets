...
namespace MakerCameraPresets
{
    ...
    public class MakerCameraPresets :BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            UITheme = Config.Bind("UI", "Button Theme", "Koikatsu", new ConfigDescription("Theme to use for the UI", themes));
        ...
        private void getUIcorner(object sender, EventArgs e)
        {
            ...
            RectTransform scrollviewConent = GameObject.Find("CustomScene/CustomRoot/FrontUIGroup/CvsDraw/Top/SidebarScrollView").GetComponent<RectTransform>();
        ...
        private void loadTextures()
        {
            ...
            buttonTx.LoadImage(File.ReadAllBytes($"{UserData.Path}/MakerCameraPresets/buttons/buttontexture{themeID}.png"));
            buttonTxHover.LoadImage(File.ReadAllBytes($"{UserData.Path}/MakerCameraPresets/buttons/buttontexture{themeID}hov.png"));
            oldUITheme = UITheme.Value;
        }
        ...
        void OnGUI()
        {
            ...
            if (!smallerButtons.Value)
            {
                ...
                baseY = Screen.height - 40 - 80 - 40 * presetData.cameras.Count;
            }
            else
            {
                baseX = (int)UIcorner.x - 85;
                baseY = Screen.height - 40 - 50 - 25 * presetData.cameras.Count;
            }
